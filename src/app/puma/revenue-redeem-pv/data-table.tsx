                                    ...
                                    {!isHeaderRow && (
                                        <>
                                            <TableCell className="px-1 py-0.5 border-r last:border-r-0 text-end dark:text-white dark:border-gray-800 !tabular-nums">
                                                <span className='text-end'>{item.target_redeem_pv}</span>
                                            </TableCell>
                                            <TableCell className="px-1 py-0.5 border-r last:border-r-0 text-end dark:text-white dark:border-gray-800 !tabular-nums">
                                                <span className='text-end'>{item.rev_cvm}</span>
                                            </TableCell>
                                            <TableCell className={cn("px-1 py-0.5 border-r last:border-r-0 text-end dark:text-white dark:border-gray-800 !tabular-nums", item.gap_to_target_redeem_pv > 0 ? 'text-green-500' : 'text-rose-500')}>
                                                <span>{item.gap_to_target_redeem_pv}</span>
                                            </TableCell>
                                            <TableCell className={cn("px-1 py-0.5 border-r last:border-r-0 text-end text-theme-xs dark:text-white dark:border-gray-800 !tabular-nums", getAchGrowthColor(item.ach_target_fm_redeem_pv) ? 'text-green-500' : 'text-rose-500')}>
                                                {item.ach_target_fm_redeem_pv}
                                            </TableCell>
                                            <TableCell className={cn("px-1 py-0.5 border-r last:border-r-0 text-end text-theme-xs dark:text-white dark:border-gray-800 !tabular-nums", getAchGrowthColor(item.drr_redeem_pv) ? 'text-green-500' : 'text-rose-500')}>
                                                {item.drr_redeem_pv}
                                            </TableCell>
...
type Revenue = {
    name: string | null;
    target_redeem_pv: number;
    rev_cvm: number;
    ach_target_fm_redeem_pv: string;
    drr_redeem_pv: string;
    gap_to_target_redeem_pv: number;
    mom_cvm: string;
