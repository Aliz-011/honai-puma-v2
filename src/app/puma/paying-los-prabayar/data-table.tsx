                                ...
                                <TableRow key={`${item.name}-${index}`}>
                                    ...
                                    {!isHeaderRow && (
                                        <>
                                            ...
                                            <TableCell className={cn("px-1 py-0.5 border-r last:border-r-0 text-end text-theme-xs dark:text-white dark:border-gray-800 !tabular-nums", getGrowthColor(item.yoy_rgb_data) ? 'text-green-500' : 'text-rose-500')}>
                                                {item.yoy_rgb_data}
                                            </TableCell>
                                            <TableCell className={cn("px-1 py-0.5 border-r last:border-r-0 text-end text-theme-xs font-medium dark:border-gray-800 !tabular-nums", getGrowthColor(item.yoy_rgb_digital) ? 'text-green-500' : 'text-rose-500')}>
                                                {item.yoy_rgb_digital}
                                            </TableCell>
                                        </>
                                    )}
                                </TableRow>
