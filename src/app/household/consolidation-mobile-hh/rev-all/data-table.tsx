                ...
                <Table>
                    ...
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead colSpan={6} className="font-medium border bg-red-700 text-gray-50 text-center dark:text-white dark:border-gray-800">Rev All Mobile (In Bio)</TableHead>
                                    ...
                                    {!isHeaderRow && (
                                        <>
                                            <TableCell className="px-1 py-0.5 border-r last:border-r-0 text-end dark:text-white dark:border-gray-800 !tabular-nums">
                                                <span className='text-end'>{formatToBillion((item.rev_all_m))}</span>
                                            </TableCell>
                                            <TableCell className="px-1 py-0.5 border-r last:border-r-0 text-end dark:text-white dark:border-gray-800 !tabular-nums">
                                                <span className='text-end'>{formatToBillion((item.rev_all_m1))}</span>
                                            </TableCell>
                                            ...
                                            <TableCell className="px-1 py-0.5 border-r last:border-r-0 text-end dark:text-white dark:border-gray-800 !tabular-nums">
                                                <span className='text-end'>{formatToBillion((item.rev_all_y))}</span>
                                            </TableCell>
                                            <TableCell className="px-1 py-0.5 border-r last:border-r-0 text-end dark:text-white dark:border-gray-800 !tabular-nums">
                                                <span className='text-end'>{formatToBillion((item.rev_all_y1))}</span>
                                            </TableCell>
