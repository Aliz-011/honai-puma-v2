                                ...
                                <TableRow key={`${item.name}-${index}`}>
                                    ...
                                    {!isHeaderRow && (
                                        <>
                                            ...
                                            <TableCell className={cn("px-1 py-0.5 border-r last:border-r-0 text-end text-theme-xs dark:text-white dark:border-gray-800 !tabular-nums", gapToTarget(item.gapToTargetAll) ? 'text-green-500' : 'text-rose-500')}>
